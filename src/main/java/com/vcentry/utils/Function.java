...
public class Function {
	...
	public static String[][] getTestData(String sheetName,String Scenario){
		String[][] data =null;
		try {
			...
			for (int i = 0; i < row; i++) {
				...
				//if(sheet.getRow(i).getCell(0).getStringCellValue().equals(Scenario)) {
						if(cell0.equals(Scenario)) {
